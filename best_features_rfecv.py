feat_xgb_vanilla_min15_clf_ros_resamp = ['3rd-Ventricle**area', 'CC_Central**area', 'CC_Posterior**area',
       'CortexVol**volume', 'Left-Caudate**area',
       'Left-Cerebellum-White-Matter**area', 'Left-vessel**area',
       'MaskVol-to-eTIV**volume', 'Optic-Chiasm**area', 'Right-Amygdala**area',
       'Right-Cerebellum-White-Matter**area', 'Right-Lateral-Ventricle**area',
       'SurfaceHoles**volume', 'lh_G&S_cingul-Mid-Ant_area**aparc.a2009s',
       ...
       'lh_inferiortemporal_volume**aparc', 'lh_pericalcarine_volume**aparc',
       ...
       'rh_S_subparietal_thickness**aparc.a2009s', 'rh_cuneus_volume**aparc',
       'rh_entorhinal_thickness**aparc', 'rh_entorhinal_volume**aparc',
       'rh_frontalpole_volume**aparc', 'rh_fusiform_area**aparc',
       'rh_fusiform_thickness**aparc', 'rh_inferiortemporal_volume**aparc',
       'rh_insula_area**aparc', 'rh_lingual_area**aparc',
       'rh_parahippocampal_volume**aparc', 'rh_parsopercularis_volume**aparc',
       'rh_posteriorcingulate_thickness**aparc',
       'rh_posteriorcingulate_volume**aparc', 'rh_precuneus_thickness**aparc',
       'rh_precuneus_volume**aparc']




feat_xgb_vanilla_min15_clf = []